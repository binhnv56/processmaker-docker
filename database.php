    ...
    */
    'connections' => [
        'processmaker' => [
            ...
            'password' => env('DB_PASSWORD', 'nextcloud'),
        ...
        'data' => [
            ...
            'host' => env('DATA_DB_HOST', 'mysql'),
            'port' => env('DATA_DB_PORT','3306'),
            'database' => env('DATA_DB_DATABASE','processmaker'),
            'username' => env('DATA_DB_USERNAME','root'),
            'password' => env('DATA_DB_PASSWORD','nextcloud'),
            'unix_socket' => env('DATA_DB_SOCKET',''),
            'charset' => $charset,
            'collation' => $collation,
            'schema' => env('DATA_DB_SCHEMA'),
            'engine' => env('DATA_DB_ENGINE','InnoDB'),
